    ...
    <div id="text-portfolio">
      ...
      <div id="experience-1">
        ...
        {/*<div className="mission-experience">
          ...
          <div className="environnement-technique">
            <div id="titre-env-tech">Environnement technique</div>
            <div id="comp-env-tech">C#, WPF, REST, WebAPI, DevExpress, MongoDB, Azure DevOps, Datalake, ETL, RabbitMQ</div>
          </div>
          <div className="environnement-fonctionnel">
            <div id="titre-env-fonct">Environnement fonctionnel</div>
            <div id="comp-env-fonct"> VaR, PnL, Risk Analysis</div>
          </div>
        </div>*/
  }
      </div>
